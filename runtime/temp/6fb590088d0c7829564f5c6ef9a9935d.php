<?php /*a:1:{s:51:"D:\phpstudy_pro\project\auth\view\admin\player.html";i:1608974711;}*/ ?>
                        ...
                        <div class="layui-colla-content layui-show larry-personal-body clearfix" style="padding: 0;">
                            <div class="block__list_words">
								...
								<?php if(is_array($auths) || $auths instanceof \think\Collection || $auths instanceof \think\Paginator): $i = 0; $__LIST__ = $auths;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<li>
                                        <i class="layui-icon layui-icon-link"></i> <?php echo htmlentities($vo['domain']); ?>   <?php echo htmlentities($vo['remark']); ?>                                     <div style="float:right">
                                            <a class="layui-btn layui-btn-danger layui-btn-xs"
                                               onclick="delauth('<?php echo htmlentities($vo['domain']); ?>','<?php echo htmlentities($vo['player_id']); ?>')" href="javascript:"><i
                    ...
                    <div class="layui-colla-item">
                        ...
                        <div class="layui-colla-content layui-show larry-personal-body clearfix" style="padding: 0;">
                            <div class="block__list_words">
								...
								<input type="hidden" name="playerId" value="<?php echo htmlentities($entity['id']); ?>">
													<ul id="playersheetlist">
														<?php if(is_array($selectedSongSheetList) || $selectedSongSheetList instanceof \think\Collection || $selectedSongSheetList instanceof \think\Paginator): $i = 0; $__LIST__ = $selectedSongSheetList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
														<li id="del<?php echo htmlentities($vo['id']); ?>">
                                    <span class="drag-handle"><img src="/static/images/type/sdtj.png" width="16px" height="16px"> <?php echo htmlentities($vo['name']); ?></span>
                                        <div style="float:right">
                                            <a class="layui-btn layui-btn-danger layui-btn-xs"
                                               onclick="delPlayerSongSheet(this)" href="javascript:"
                                               ss-name="<?php echo htmlentities($vo['name']); ?>"><i
                                                    class="layui-icon layui-icon-delete"></i>删除</a>
                                        </div>
                                       <input type="hidden" name="ids[]" value="<?php echo htmlentities($vo['id']); ?>">
                                    </li>
														<?php endforeach; endif; else: echo "" ;endif; ?>
													</ul>
												</form>
            ...
            <div class="layui-tab layui-tab-card" style="margin-top: 10px;border-width: 0;">
                ...
                <div class="layui-tab-content" style="padding: 0;">
                    <div class="layui-tab-item  layui-show">
                        <div class="layui-form layui-form-pane">
                            <table class="layui-table" style="margin: 0;">
                                <tbody>
								<?php if(is_array($userSongSheet) || $userSongSheet instanceof \think\Collection || $userSongSheet instanceof \think\Paginator): $i = 0; $__LIST__ = $userSongSheet;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								<tr>
                                    <td width="2%"><img
                                            src="/static/images/type/sdtj.png" width="16px" height="16px"></td>
                                    <td width="100%"><?php echo htmlentities($vo['name']); ?></td>
                                    <td width="2%"><a class="addSongSheet layui-btn layui-btn-primary layui-btn-xs"
                                                       class="addSongSheet" href="javascript:" ss-id="<?php echo htmlentities($vo['id']); ?>" ss-name="<?php echo htmlentities($vo['name']); ?>"><i
                    ...
                    <div class="layui-tab-item">
                        <table class="layui-table" style="margin: 0;">
                            <tbody>
							<?php if(is_array($gy) || $gy instanceof \think\Collection || $gy instanceof \think\Paginator): $i = 0; $__LIST__ = $gy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                 <tr>
                                    <td width="2%"><img
                                            src="/static/images/type/sdtj.png" width="16px" height="16px"></td>
                                    <td width="100%"><?php echo htmlentities($vo['name']); ?></td>
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form layui-form-pane">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" lay-verify="required" value="<?php echo htmlentities($entity['id']); ?>"
                                               class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                ...
                                <div class="layui-form layui-form-pane">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" lay-verify="required" disabled="disabled" value="<?php echo htmlentities($entity['id']); ?>" class="layui-input layui-disabled" style="color:#000!important">
                                        </div>
                                    </div>
									...
									<div class="layui-form-item">
                                        ...
                                        <div class="layui-input-inline">
											...
											<?php if($userInfo['power'] == '2'): ?>
											<option value="1" <?php if( $entity['theme'] == '1' ) echo  'selected = "selected"' ; ?>>白色简洁</option>
											<?php else: ?>
											<option value="1" <?php if( $entity['theme'] == '1' ) echo  'selected = "selected"' ; ?>>白色简洁</option>
											<option value="2" <?php if( $entity['theme'] == '2' ) echo  'selected = "selected"' ; ?>>透明多彩</option>
											<option value="3" <?php if( $entity['theme'] == '3' ) echo  'selected = "selected"' ; ?>>高斯模糊</option>
											<option value="4" <?php if( $entity['theme'] == '4' ) echo  'selected = "selected"' ; ?>>透白阴影</option>
											<option value="5" <?php if( $entity['theme'] == '5' ) echo  'selected = "selected"' ; ?>>圆润通透</option>
											<?php endif; ?>
											</select>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="checkbox" name="phone_load"
                                                       lay-skin="switch" value="1" <?php if( $entity['phone_load'] == '1' ) echo  'checked' ; ?>>
                                            </div>
                                        </div>
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="checkbox" name="show_lrc" lay-skin="switch" value="1"
                                                       <?php if( $entity['show_lrc'] == '1' ) echo  'checked' ; ?>>
                                            </div>
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-block">
                                                ...
                                                <?php if( $entity['random_player'] == '1' ) echo  'checked' ; ?>>
                                            </div>
                                        </div>
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="checkbox" name="auto_player" lay-skin="switch" value="1"
                                                       <?php if( $entity['auto_player'] == '1' ) echo  'checked' ; ?>>
                                            </div>
                                        </div>
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-block">
                                                ...
                                                <?php if( $entity['show_notes'] == '1' ) echo  'checked' ; ?>>
                                            </div>
                                        </div>
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-block">
                                                ...
                                                <?php if( $entity['showmsg'] == '1' ) echo  'checked' ; ?>>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="checkbox" name="switchopen" lay-skin="switch" value="1"
                                                    <?php if( $entity['switchopen'] == '1' ) echo  'checked' ; ?>>
                                            </div>
                                        </div>
                                        <div class="layui-inline">
                                            <label class="layui-form-label">几秒后弹出</label>
                                            <div class="layui-input-inline">
                                                <input type="text" name="time" value="<?php echo htmlentities($entity['time']); ?>" placeholder="延迟弹出时间"
                                    ...
                                    <div class="layui-form-item">
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-block">
                                                ...
                                                <?php if( $entity['show_greeting'] == '1' ) echo  'checked' ; ?>>
                                            </div>
                                        </div>
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" name="greeting" lay-verify="required"
                                                       value="<?php echo htmlentities($entity['greeting']); ?>" placeholder="站点打开欢迎语" autocomplete="off"
                                                        class="layui-input">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="default_volume" lay-verify="required"
                                                       value="<?php echo htmlentities($entity['default_volume']); ?>" placeholder="请输入默认音量"
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="default_album" lay-verify="required"
                                                       value="<?php echo htmlentities($entity['default_album']); ?>" placeholder="请输入默认专辑序号"
                                                       autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="name" lay-verify="required" id="playername"
                                                       value="<?php echo htmlentities($entity['name']); ?>" placeholder="请输入播放器名称" autocomplete="off"
                                                       class="layui-input">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="layui-tab-item">
                                <div class="layui-form layui-form-pane">
                                    <blockquote class="layui-elem-quote">本页面可设置播放器未授权使用时的语音提示，由百度开放API文字转语音合成
                                        ...
                                        <textarea name="voice_msg" class="layui-textarea" style="margin: 10px 0;"><?php echo htmlentities($entity['voice_msg']); ?></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
...
<script>
    layui.use(['admin', 'form','colorpicker'], function(){
		...
		$('#script_code').val('<div id="music" key="<?php echo htmlentities($entity['id']); ?>" api="'+(document.location.protocol === "http:" ? "http" : "https")+'://'
            +document.location.host+'"></div><script id="xplayer" src="'+(document.location.protocol === "http:" ? "http" : "https")+'://'
            +document.location.host+'/api/PlayerJs/id/<?php echo htmlentities($entity['id']); ?>" ><\/script>');
		...
		$('#adddomain').click(function () {
			if ($("#domain").val() == '') {
				...
				layer.confirm('授权域名：' + domain + ' 使用播放器?', {
					...
					$.post("/AdminAjax/Player/act/auth", {domain: domain, id: '<?php echo htmlentities($entity['id']); ?>', remark: remark}, function (data) {
						if (data.code === 0) {
							layer.msg("授权添加成功！", {icon: 6, time: 2000, shade: [0.3, '#000']});
								setTimeout(function () {

							location.replace('#/player/id/<?php echo htmlentities($entity['id']); ?>');
								}, 1000);
		...
		$('#loadPlayer').click(function () {
            layer.confirm('是否要测试播放器：<?php echo htmlentities($entity['name']); ?>', {
                icon: 3,
                title: '测试播放器'
            }, function () {
                $('#loadPlayer').hide();
				...
				div.setAttribute("key", "<?php echo htmlentities($entity['id']); ?>");
                ...
                script.setAttribute("src", (document.location.protocol === "http:" ? "http" : "https") + "://" + document.location.host + "/api/PlayerJs/id/<?php echo htmlentities($entity['id']); ?>");
